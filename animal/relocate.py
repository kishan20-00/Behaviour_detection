...
source_dirs = ['F:/KA Projects/Thushani/animal/abnormal', 'F:/KA Projects/Thushani/animal/normal']
destination_dir = 'F:/KA Projects/Thushani/animal/Images/test'
num_files_to_move = [26, 124]  # Number of files to move from each source directory
